...
class Scanner {
    public const STR_QUOTE = "\"";
    public const STR_EQUAL = "=";
    public const STR_LEFT_PAREN = "(";
    public const STR_RIGHT_PAREN = ")";
    public const STR_LEFT_BRACE = "{";
    public const STR_RIGHT_BRACE = "}";
    public const STR_SLASH = "/";
    public const STR_NEWLINE = "\n";
    public const STR_COMMA = ",";
    public const STR_DOT = ".";
    public const STR_MINUS = "-";
    public const STR_PLUS = "+";
    public const STR_SEMICOLON = ";";
    public const STR_STAR = "*";
    public const STR_BANG = "!";
    public const STR_LESS_THAN = "<";
    public const STR_GREATER_THAN = ">";
    public const STR_SPACE = " ";
    public const STR_CR = "\r";
    public const STR_TAB = "\t";
