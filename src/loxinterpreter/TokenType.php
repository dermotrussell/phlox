...
enum TokenType {
    ...
    case BANG; case BANG_EQUAL; case EQUAL; case EQUAL_EQUAL;
    ...
    // Keywords
    case AND; case _CLASS; case ELSE; case FALSE; case FUN; case FOR; case IF; case NIL; case OR;
    case PRINT; case RETURN; case SUPER; case THIS; case TRUE; case VAR; case WHILE;
